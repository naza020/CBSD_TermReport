...
@NamedQueries({
    ...
    @NamedQuery(name = "Covid.findByYears", query = "SELECT c FROM Covid c WHERE c.covidPK.years = :years"),
    @NamedQuery(name = "Covid.findByWeeknum", query = "SELECT c FROM Covid c WHERE c.covidPK.weeknum = :weeknum"),
...
public class Covid implements Serializable {
    ...
    public Covid(CovidPK covidPK) {
        this.covidPK = covidPK;
    }

    public Covid(int years, int weeknum) {
        this.covidPK = new CovidPK(years, weeknum);
    }

    public CovidPK getCovidPK() {
        return covidPK;
    }

    public void setCovidPK(CovidPK covidPK) {
        this.covidPK = covidPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (covidPK != null ? covidPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.covidPK == null && other.covidPK != null) || (this.covidPK != null && !this.covidPK.equals(other.covidPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "model.Covid[ covidPK=" + covidPK + " ]";
    }
